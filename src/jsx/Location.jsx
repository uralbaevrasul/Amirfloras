        ...
        <div className="relative h-[550px] w-full rounded-[2.5rem] overflow-hidden shadow-2xl border border-pink-50">
          ...
          <div className="absolute inset-0 flex items-center justify-center md:justify-between px-6 md:px-20">
            ...
            <div className="bg-white/90 backdrop-blur-md p-8 md:p-12 rounded-[2rem] shadow-2xl max-w-sm w-full border border-white/50">
              <h2 className="text-3xl font-serif font-bold mb-8 text-gray-800 tracking-tight">
                Наш салон
              </h2>
            ...
            <div className="flex flex-col items-center gap-4 mt-8 md:mt-0">
              <div className="relative">
                ...
                <div className="absolute -inset-6 md:-inset-8 bg-pink-500 rounded-full opacity-20 animate-ping"></div>
                <div className="absolute -inset-3 md:-inset-4 bg-pink-400 rounded-full opacity-30 animate-pulse"></div>

                <a
                  href="https://www.google.com/maps/search/Чиланзар,+6-й+квартал"
                  target="_blank"
                ...
                >
                  {/* Iconka o'lchami mobilda biroz kichraytirildi */}
                  <MapPin
                    size={30}
                    className="md:w-10 md:h-10 text-pink-500 group-hover:text-white transition-colors"
                  />
                </a>
              </div>
              <span className="bg-white/80 backdrop-blur-sm px-4 py-2 rounded-full text-[10px] md:text-xs font-bold text-gray-700 shadow-sm border border-white text-center">
